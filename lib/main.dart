...
class _RequestProfessionPickerState extends State<_RequestProfessionPicker> {
  ...
  static const _fallback = [
    ...
    'Τέντες - Σκίαστρα', 'Τεχνικός Υπολογιστών', 'Τεχνίτρια Νυχιών', 'Smart Home - Συστήματα Ασφαλείας', 'Υαλουργός', 'Υδραυλικός',
...
const List<Map<String, dynamic>> _specialtyCategories = [
  {
    ...
    'items': [
      ...
      'Συναρμολόγηση Επίπλων', 'Τέντες - Σκίαστρα', 'Υαλουργός', 'Υδραυλικός', 'Υπηρεσία Αποξήλωσης',
