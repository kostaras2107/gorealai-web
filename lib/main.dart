...
const Map<String, String> _vocativeDict = {
  // -ης endings
  'γιαννης': 'Γιάννη', 'αντωνης': 'Αντώνη', 'βασιλης': 'Βασίλη',
  'μιχαλης': 'Μιχάλη', 'παναγιωτης': 'Παναγιώτη', 'δημητρης': 'Δημήτρη',
  'θανασης': 'Θανάση', 'σωτηρης': 'Σωτήρη', 'λευτερης': 'Λευτέρη',
  'σταθης': 'Στάθη', 'μανωλης': 'Μανώλη', 'παντελης': 'Παντελή',
  'αγγελης': 'Αγγελή', 'κωστης': 'Κώστη', 'ορεστης': 'Ορέστη',
  'γρηγορης': 'Γρηγόρη', 'φωτης': 'Φώτη', 'αλεξης': 'Αλέξη',
  'μακης': 'Μάκη', 'αριστειδης': 'Αριστείδη', 'σωκρατης': 'Σωκράτη',
  'θεμιστοκλης': 'Θεμιστοκλή', 'αριστοτελης': 'Αριστοτέλη',
...
class _LoginScreenState extends State<LoginScreen>
  ...
  Future<void> _submitRegister() async {
    ...
    try {
      ...
      if (_role == 'professional') {
        await FirebaseFirestore.instance.collection('professionals').doc(cred.user!.uid).set({
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              // Flexible+ellipsis αντί για απλό Text: χωρίς όριο πλάτους, σε
              // στενότερες οθόνες ή με μεγαλύτερη γραμματοσειρά συστήματος
...
const List<Map<String, dynamic>> _subSpecialtyCategories = [
  ...
  },
  {
    ...
    'items': ['Τοιχοποιία & Κτίσιμο', 'Πλακίδια & Δάπεδα', 'Ξυλουργικές Εργασίες', 'Αλουμίνιο & Κουφώματα', 'Υαλοτοιχία', 'Δώμα & Στέγη', 'Μόνωση Ταράτσας', 'Μόνωση Εξωτερικής Τοιχοποιίας', 'Μόνωση Υπογείου', 'Γυψοσανίδες & Ψευδοροφές', 'Μεταλλικές Κατασκευές'],
  },
  {
    'category': 'Δάπεδα & Επιφάνειες',
    'items': ['Γυάλισμα Μαρμάρων', 'Γυάλισμα Γρανίτη', 'Γυάλισμα Terrazzo', 'Τοποθέτηση Παρκέ', 'Επισκευή Δαπέδου', 'Εποξειδικά Δάπεδα', 'Βερνίκωμα Ξύλου'],
  },
  {
    'category': 'Καθαριότητα & Συντήρηση',
    'items': ['Γενικός Καθαρισμός', 'Καθαρισμός Μετά Κατασκευή', 'Καθαρισμός Τζαμιών', 'Μετακόμιση', 'Κηπουρική', 'Εγκαταστάσεις CCTV & Συναγερμός', 'Smart Home - Συστήματα Ασφαλείας', 'Εγκατάσταση Ασανσέρ', 'Φύλαξη & Ασφάλεια'],
  },
  {
    'category': 'Αυτοκίνητο',
  ...
  {
    'category': 'Εκπαίδευση & Υπηρεσίες',
    'items': ['Ιδιαίτερα Αγγλικών', 'Ιδιαίτερα Μαθηματικών', 'Ιδιαίτερα Φυσικής', 'Εκπαίδευση Σκύλου', 'Φροντίδα Κατοικίδιου', 'Tattoo', 'Φωτογράφος Εκδηλώσεων', 'Βιντεογράφος'],
  },
];
...
class _HomeScreenState extends State<HomeScreen> with WidgetsBindingObserver {
  ...
  void _listenActiveRequest(String uid) {
    // Παρακολουθεί active ΚΑΙ expired αιτήματα (χωρίς orderBy). Το status
    // πλέον αλλάζει αυτόματα σε 'expired' ακριβώς τη στιγμή που λήγει το
    // αίτημα (βλ. backend sendExpiryNotification) — αν φιλτράραμε εδώ μόνο
    // 'active', το έγγραφο θα εξαφανιζόταν αμέσως από αυτό το real-time
    // listener την ίδια ακριβώς στιγμή που ο πελάτης παίρνει SMS/email "βρέθηκε
    // επαγγελματίας!", πριν προλάβει να τρέξει η λογική του 48ωρου grace period
    // παρακάτω που δείχνει ειδικά αυτή την κάρτα.
        ...
        child: Column(children: [
                    ...
                    if (_isPro) ...[
                      StreamBuilder<QuerySnapshot>(
                        ...
                        builder: (context, snapChats) {
                          ...
                          // Count active requests the pro hasn't responded to
                          return StreamBuilder<QuerySnapshot>(
                            stream: _userId != null
                                ? FirebaseFirestore.instance
                                    .collection('offers')
                                    .where('professionalId', isEqualTo: _userId)
                                    .snapshots()
                                : const Stream.empty(),
                            builder: (context, snapOffers) {
                          final respondedIds = snapOffers.hasData
          ...
          StreamBuilder<QuerySnapshot>(
            stream: _userId != null
                ...
                : const Stream.empty(),
            builder: (_, snapUserChats) {
              int unreadUserMsgs = 0;
              if (snapUserChats.hasData) {
                for (final d in snapUserChats.data!.docs) {
                  unreadUserMsgs += (((d.data() as Map)['unreadUser'] as int?) ?? 0);
                }
              }
              return _BottomNav(
            navIndex: _navIndex,
          ...
          if (!isCompleted && secs > 0) ...[
            ...
            Row(children: [
              ...
              Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                const SizedBox(height: 6),
                _StatRow(icon: '🔥', label: '$_offersCount προσφορές μέχρι τώρα', highlight: _offersCount > 0),
                const SizedBox(height: 6),
...
class _ProfessionalHomeScreenState extends State<ProfessionalHomeScreen> {
  ...
  String? _proDocId; // actual Firestore doc ID in professionals collection
  ...
  Future<void> _loadProfile() async {
    ...
    // Αν το professionals doc δεν έχει profilePhotoUrl αλλά το users doc έχει, αντίγραψέ το
    final photoFromUsers = d['profilePhotoUrl'] as String?;
    if ((dp['profilePhotoUrl'] == null || (dp['profilePhotoUrl'] as String?)!.isEmpty) &&
        photoFromUsers != null && photoFromUsers.isNotEmpty) {
      FirebaseFirestore.instance.collection('professionals').doc(resolvedDocId)
          .set({'profilePhotoUrl': photoFromUsers}, SetOptions(merge: true));
    }
                ...
                child: Stack(children: [
                  ...
                  Positioned(bottom: 0, right: 0,
                    child: Container(
                      ...
                      child: const Icon(Icons.camera_alt, size: 9, color: Colors.black),
                    )),
                ]),
              ),
            ]),
                      ...
                      children: [
                        ...
                        _buildNavCard('messages', '💬', 'Μηνύματα', 'Εξυπηρέτηση πελατών',
                            ...
                            customOnTap: () => Navigator.push(context, MaterialPageRoute(
                                builder: (_) => MessagesScreen(userId: _proId ?? '', isPro: true)))),
  ...
  Widget _buildMiniCvSection() {
    ...
    final fields = [
      ...
      _subSpecialties.isNotEmpty,
      _areas.isNotEmpty,
      _companyName.isNotEmpty,
      _yearsExperience > 0,
    ];
    final completed = fields.where((f) => f).length;
    final pct = (completed / fields.length * 100).round();
      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            gradient: LinearGradient(
              begin: Alignment.topLeft, end: Alignment.bottomRight,
              colors: [const Color(0xFF1A1033), const Color(0xFF0D1B2E)],
            ),
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Row(children: [
              Container(
                ...
                child: Center(child: Text('$pct%', style: const TextStyle(color: Colors.black, fontSize: 13, fontWeight: FontWeight.w900))),
              ),
              const SizedBox(width: 14),
              Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Text(pct == 100 ? 'Πλήρες Προφίλ 🏆' : 'Συμπλήρωσε το προφίλ σου',
                    style: const TextStyle(color: Colors.white, fontSize: 15, fontWeight: FontWeight.w700)),
                const SizedBox(height: 2),
                Text('$completed από ${fields.length} πεδία συμπληρωμένα',
                    style: TextStyle(color: _g(0.45), fontSize: 12)),
              ])),
            ]),
            const SizedBox(height: 14),
            ClipRRect(
        ...
        _MiniCvCard(
          ...
          iconColor: kGold,
          title: 'Βιογραφικό',
          subtitle: 'Ποιος είσαι και τι προσφέρεις',
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child: const Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  SizedBox(width: 8),
                  Text('Αποθήκευση', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w800, fontSize: 14)),
                ]),
              ),
            ),
          ]),
        ...
        _MiniCvCard(
          ...
          iconColor: kGold,
          title: 'Επαγγέλματα',
          subtitle: 'Οι κύριες ειδικότητές σου',
          isDone: _specialties.isNotEmpty,
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Wrap(spacing: 8, runSpacing: 8, children: _specialties.map((s) =>
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Row(mainAxisSize: MainAxisSize.min, children: [
                      Text(s, style: const TextStyle(color: kGold, fontSize: 12, fontWeight: FontWeight.w700)),
            ...
            GestureDetector(
              ...
              child: _cvPickerButton(
                ...
                color: kGold,
                label: _specialties.isEmpty ? 'Επίλεξε επαγγέλματα' : 'Επεξεργασία επαγγελμάτων',
              ),
            ),
          ]),
        ),
        ...
        _MiniCvCard(
          ...
          iconColor: const Color(0xFF9B97FF),
          title: 'Ειδικότητες',
          subtitle: 'Αναλυτικές δεξιότητες & τεχνικές',
          isDone: _subSpecialties.isNotEmpty,
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Wrap(spacing: 8, runSpacing: 8, children: _subSpecialties.map((s) =>
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Row(mainAxisSize: MainAxisSize.min, children: [
                      Text(s, style: const TextStyle(color: Color(0xFF9B97FF), fontSize: 12, fontWeight: FontWeight.w700)),
                      const SizedBox(width: 7),
                      Container(width: 15, height: 15,
                        decoration: BoxDecoration(color: Colors.red.withValues(alpha: 0.8), shape: BoxShape.circle),
                        child: const Icon(Icons.close, color: Colors.white, size: 9)),
            ...
            GestureDetector(
              ...
              child: _cvPickerButton(
                ...
                label: _subSpecialties.isEmpty ? 'Επίλεξε ειδικότητες' : 'Επεξεργασία ειδικοτήτων',
              ),
            ),
          ]),
        ),
        ...
        _MiniCvCard(
          ...
          subtitle: 'Πού εργάζεσαι;',
          isDone: _areas.isNotEmpty,
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Wrap(spacing: 8, runSpacing: 8, children: _areas.map((a) =>
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Row(mainAxisSize: MainAxisSize.min, children: [
                      Text(a, style: const TextStyle(color: kGreen, fontSize: 12, fontWeight: FontWeight.w700)),
                      const SizedBox(width: 7),
                      Container(width: 15, height: 15,
                        decoration: BoxDecoration(color: Colors.red.withValues(alpha: 0.8), shape: BoxShape.circle),
                        child: const Icon(Icons.close, color: Colors.white, size: 9)),
            ...
            GestureDetector(
              ...
              child: _cvPickerButton(
                ...
                color: kGreen,
                label: _areas.isEmpty ? 'Επίλεξε περιοχές' : 'Επεξεργασία περιοχών',
              ),
            ),
          ]),
        ),
        ...
        _MiniCvCard(
          ...
          subtitle: 'Επωνυμία & αξιολογήσεις Google',
          isDone: _companyName.isNotEmpty,
        ...
        _MiniCvCard(
          ...
          subtitle: 'Πόσα χρόνια δουλεύεις στο χώρο;',
          isDone: _yearsExperience > 0,
          child: _editingYears
            ? Column(children: [
                TextField(
                  ...
                  ? Row(children: [
                      Container(
                        ...
                        child: Row(mainAxisSize: MainAxisSize.min, children: [
                          ...
                          const SizedBox(width: 6),
                          Text('$_yearsExperience χρόνια εμπειρίας', style: const TextStyle(color: Colors.black, fontSize: 13, fontWeight: FontWeight.w800)),
                        ]),
                      ),
                      const Spacer(),
                      Container(
                        ...
                        child: Icon(Icons.edit, color: _g(0.4), size: 15),
                      ),
                    ])
                  : _cvPickerButton(icon: Icons.add_circle_outline, color: kGold, label: 'Πρόσθεσε χρόνια εμπειρίας'),
              ),
        ),
        const SizedBox(height: 20),
      ],
  ...
  Widget _cvPickerButton({required IconData icon, required Color color, required String label}) {
    return Container(
      ...
      child: Row(children: [
        ...
        const SizedBox(width: 10),
        Text(label, style: TextStyle(color: color.withValues(alpha: 0.9), fontSize: 13, fontWeight: FontWeight.w600)),
        const Spacer(),
  ...
  Widget _MiniCvCard({
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: isDone ? iconColor.withValues(alpha: 0.25) : Colors.white.withValues(alpha: 0.06),
        ),
      ),
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        // Card header
        ...
        // Divider
        Container(height: 1, color: Colors.white.withValues(alpha: 0.05), margin: const EdgeInsets.symmetric(horizontal: 16)),
        // Card body
        Padding(
          padding: const EdgeInsets.all(16),
          child: child,
  ...
  Widget _buildSocialSection() {
    return ListView(
      ...
      children: [
        _SectionCard(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            if (_instagramUrl.isNotEmpty)
              GestureDetector(
                onTap: () {
                  final url = _instagramUrl.startsWith('http') ? _instagramUrl : 'https://www.instagram.com/${_instagramUrl.replaceAll('@', '').trim()}';
        ...
        _SectionCard(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            if (_tiktokUrl.isNotEmpty)
              GestureDetector(
                onTap: () {
                  String rawUrl = _tiktokUrl.startsWith('http') ? _tiktokUrl : 'https://www.tiktok.com/@${_tiktokUrl.replaceAll('@', '').trim()}';
                  try { final u = Uri.parse(rawUrl); rawUrl = u.replace(host: u.host.replaceAll(RegExp(r'\.{2,}'), '.')).toString(); } catch(_) {}
                  final url = rawUrl;
                  launchUrl(Uri.parse(url), mode: LaunchMode.externalApplication);
                },
                child: Container(
        ...
        if (_editingSocial) ...[
          _SectionCard(
            title: 'Επεξεργασία Social Media',
            child: Column(children: [
              TextField(
                controller: _igCtrl,
                style: const TextStyle(color: Colors.white, fontSize: 14),
                decoration: InputDecoration(
                  prefixIcon: const Padding(padding: EdgeInsets.all(12), child: Text('📸', style: TextStyle(fontSize: 18))),
                  prefixText: '@',
                  prefixStyle: const TextStyle(color: Colors.white54, fontSize: 14, fontWeight: FontWeight.w600),
                  hintText: 'username',
                  hintStyle: TextStyle(color: _g(0.3), fontSize: 13),
                  border: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: BorderSide(color: _g(0.1))),
                  enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: BorderSide(color: _g(0.1))),
                  focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: const BorderSide(color: Color(0xFFE1306C))),
                  filled: true, fillColor: _g(0.04),
                ),
              ),
              const SizedBox(height: 12),
              ...
              Row(children: [
                Expanded(child: GestureDetector(
                  onTap: () => setState(() => _editingSocial = false),
                ...
                Expanded(child: GestureDetector(
                  onTap: () async {
                    ...
                    if (mounted) {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(content: const Text('Social Media αποθηκεύτηκαν ✓'), backgroundColor: kGold.withValues(alpha: 0.9), duration: const Duration(seconds: 2)));
                    }
                  },
                  child: Container(padding: const EdgeInsets.symmetric(vertical: 12),
                    ...
                    child: const Center(child: Text('Αποθήκευση', style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 13)))),
                )),
              ]),
            ]),
          ),
          ...
          GestureDetector(
            onTap: () {
              _igCtrl.text = _instagramUrl;
              _ttCtrl.text = _tiktokUrl;
              setState(() => _editingSocial = true);
            },
            child: Container(
              padding: const EdgeInsets.symmetric(vertical: 14),
...
class _RequestProfessionPickerState extends State<_RequestProfessionPicker> {
  ...
  static const _fallback = [
    ...
    'Καθηγητής Μαθηματικών', 'Catering', 'Κηπουρός', 'Κτίστης',
    'Λογιστής', 'Μεταλλικές Κατασκευές', 'Μετακομίσεις',
    'Μονώσεις - Διαχείριση & Αντιμετώπιση Υγρασίας', 'Νοσηλευτής κατ\' οίκον', 'Οδοντίατρος',
    'Personal Trainer', 'Πλακάς', 'Συνεργείο Ανακαίνισης',
    'Συνεργείο Βαφής & Διακόσμησης', 'Συνεργείο Ηλεκτρολόγων', 'Συνεργείο Κατασκευών', 'Συνεργείο Κλιματισμού',
    'Συνεργείο Υδραυλικών', 'Συναρμολόγηση Επίπλων', 'Συντήρηση Κλιματιστικών', 'Tattoo Artist',
    'Τέντες - Σκίαστρα', 'Τεχνικός Καυστήρων', 'Τεχνικός Υπολογιστών', 'Τεχνίτρια Νυχιών', 'Smart Home - Συστήματα Ασφαλείας', 'Υαλουργός', 'Υδραυλικός',
    'Υπηρεσία Αποξήλωσης', 'Φιλόλογος', 'Φωτογράφος', 'Φωτογράφος Εκδηλώσεων',
    'Web Developer', 'Ξυλουργός', 'Ψυκτικός', 'Ψυχολόγος',
  ];
  ...
  Future<void> _showPicker() async {
    ...
    final result = await showModalBottomSheet<String>(
      ...
      backgroundColor: Colors.transparent,
      isScrollControlled: true,
      builder: (ctx) => _CategorySpecialtyPicker(selected: widget.value),
    );
...
// ── Category + Alphabetical Specialty Picker (for request form) ──
class _CategorySpecialtyPicker extends StatefulWidget {
  final String? selected;
  const _CategorySpecialtyPicker({this.selected});
  @override
  State<_CategorySpecialtyPicker> createState() => _CategorySpecialtyPickerState();
}
class _CategorySpecialtyPickerState extends State<_CategorySpecialtyPicker> {
  String? _sel;
  String _search = '';
    ...
    return Container(
      ...
      child: Column(children: [
        ...
        Padding(
          ...
          child: Row(children: [
            const Text('Επιλογή Επαγγέλματος', style: TextStyle(color: Colors.white, fontSize: 17, fontWeight: FontWeight.w700)),
            const Spacer(),
            if (_sel != null)
              GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(borderRadius: BorderRadius.circular(20), gradient: const LinearGradient(colors: [kGold, Color(0xFFCC8800)])),
                  child: const Text('OK', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w800, fontSize: 13)),
                ),
              ),
          ]),
        ),
              ...
              ...items.map((item) {
                ...
                return GestureDetector(
                  ...
                  child: AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(12),
                      color: isSel ? kGold.withValues(alpha: 0.12) : Colors.white.withValues(alpha: 0.04),
                      border: Border.all(color: isSel ? kGold.withValues(alpha: 0.5) : Colors.white.withValues(alpha: 0.07)),
                    ),
                    child: Row(children: [
                      Expanded(child: Text(item,
                          style: TextStyle(color: isSel ? kGold : Colors.white,
                              fontSize: 14, fontWeight: isSel ? FontWeight.w700 : FontWeight.w400))),
                      if (isSel) const Icon(Icons.check_circle, color: kGold, size: 18),
                    ]),
                  ),
                );
              }),
...
class _AIInsightsWidget extends StatelessWidget {
  ...
  String _detectProfession(String t) {
    t = t.toLowerCase();
    if (t.contains('κατσαρίδ') || t.contains('ποντίκ') || t.contains('έντομ') || t.contains('απολύμ') || t.contains('απεντόμ') || t.contains('μυοκτ')) return 'Απολυμάνσεις - Απεντομώσεις - Μυοκτονίες';
    if (t.contains('γκαραζόπορτ') || t.contains('ρολό') || t.contains('συρόμεν')) return 'Γκαραζόπορτες - Ρολά - Συρόμενα';
    if (t.contains('τέντ') || t.contains('σκίαστρ') || t.contains('περγκόλ')) return 'Τέντες - Σκίαστρα';
...
class _RequestScreenState extends State<RequestScreen>
  ...
  // Ενδεικτικό παράδειγμα περιγραφής ανά επάγγελμα, ώστε το hint text στο
  ...
  static const Map<String, String> _descriptionHints = {
    ...
    'Ηλεκτρολόγος': 'πχ. "Θέλω να αλλάξω τον ηλεκτρικό πίνακα του σπιτιού..."',
    'Καθαρίστρια': 'πχ. "Χρειάζομαι γενικό καθάρισμα σε διαμέρισμα 80τμ..."',
    'Αποφράξεις': 'πχ. "Έχει βουλώσει ο σιφώνι στο μπάνιο..."',
    'Απολυμάνσεις - Απεντομώσεις - Μυοκτονίες': 'πχ. "Έχω δει κατσαρίδες στην κουζίνα, θέλω απεντόμωση..."',
    'Μετακομίσεις': 'πχ. "Θέλω να μεταφέρω έπιπλα από 2ο σε 4ο όροφο..."',
    'Κλιματισμός': 'πχ. "Θέλω εγκατάσταση κλιματιστικού στο υπνοδωμάτιο..."',
    'Συντήρηση Κλιματιστικών': 'πχ. "Θέλω σέρβις/καθαρισμό σε 2 κλιματιστικά..."',
    'Ψυκτικός': 'πχ. "Το ψυγείο μου δεν κρυώνει αρκετά..."',
    'Κηπουρός': 'πχ. "Θέλω κλάδεμα δέντρων και γκαζόν στην αυλή μου..."',
    'Κτίστης': 'πχ. "Θέλω να χτίσω έναν τοίχο περίφραξης..."',
    'Ξυλουργός': 'πχ. "Θέλω να φτιάξω μια ντουλάπα κατά παραγγελία..."',
    'Γυψοσανίδες': 'πχ. "Θέλω ψευδοροφή στο σαλόνι μου..."',
    'Γυάλισμα Μαρμάρων': 'πχ. "Θέλω γυάλισμα στα μάρμαρα του χολ..."',
    'Πλακάς': 'πχ. "Θέλω να βάλω πλακάκια στην κουζίνα..."',
    'Αλουμινάς': 'πχ. "Θέλω καινούργια κουφώματα αλουμινίου..."',
    'Γκαραζόπορτες - Ρολά - Συρόμενα': 'πχ. "Χάλασε το ρολό του γκαράζ μου..."',
    'Μεταλλικές Κατασκευές': 'πχ. "Θέλω μια μεταλλική κουπαστή για τη σκάλα..."',
    'Μονώσεις - Διαχείριση & Αντιμετώπιση Υγρασίας': 'πχ. "Έχω υγρασία στον τοίχο του υπνοδωματίου..."',
    'Υαλουργός': 'πχ. "Έσπασε ένα τζάμι στο παράθυρο..."',
    'Τέντες - Σκίαστρα': 'πχ. "Θέλω τέντα στο μπαλκόνι μου..."',
    'Smart Home - Συστήματα Ασφαλείας': 'πχ. "Θέλω κάμερες ασφαλείας στο σπίτι μου..."',
    'Εγκατάσταση Ηλιακών': 'πχ. "Θέλω να εγκαταστήσω ηλιακό θερμοσίφωνα..."',
    'Υπηρεσία Αποξήλωσης': 'πχ. "Θέλω αποξήλωση παλιάς κουζίνας..."',
    'Συνεργείο Ανακαίνισης': 'πχ. "Θέλω πλήρη ανακαίνιση μπάνιου..."',
    'Συνεργείο Βαφής & Διακόσμησης': 'πχ. "Θέλω βαφή και διακόσμηση στο καθιστικό..."',
    'Συνεργείο Ηλεκτρολόγων': 'πχ. "Θέλω πλήρη ηλεκτρολογική εγκατάσταση σε νέο σπίτι..."',
    'Συνεργείο Κατασκευών': 'πχ. "Θέλω κατασκευή υπόστεγου στην αυλή..."',
    'Συνεργείο Κλιματισμού': 'πχ. "Θέλω εγκατάσταση κλιματιστικών σε 3 δωμάτια..."',
    'Συνεργείο Υδραυλικών': 'πχ. "Θέλω πλήρη υδραυλική εγκατάσταση σε ανακαίνιση..."',
    'Συναρμολόγηση Επίπλων': 'πχ. "Αγόρασα ντουλάπα IKEA και θέλω να τη συναρμολογήσω..."',
    'Διακοσμητής Εσωτερικών Χώρων': 'πχ. "Θέλω βοήθεια στη διακόσμηση του σαλονιού μου..."',
    'Τεχνικός Υπολογιστών': 'πχ. "Ο υπολογιστής μου είναι πολύ αργός, θέλω επισκευή..."',
    'Web Developer': 'πχ. "Θέλω να φτιάξω μια ιστοσελίδα για την επιχείρησή μου..."',
    'Γραφίστας': 'πχ. "Θέλω σχεδιασμό λογότυπου για την επιχείρησή μου..."',
    'Φωτογράφος': 'πχ. "Θέλω φωτογράφιση πορτρέτου..."',
    'Φωτογράφος Εκδηλώσεων': 'πχ. "Θέλω φωτογράφο για τη βάφτιση του παιδιού μου..."',
    'DJ / Μουσική Εκδηλώσεων': 'πχ. "Θέλω DJ για πάρτι γενεθλίων..."',
    'Catering': 'πχ. "Θέλω catering για 50 άτομα σε βάφτιση..."',
    'Διοργάνωση Πάρτυ': 'πχ. "Θέλω διοργάνωση πάρτι γενεθλίων για παιδί..."',
    'Εκδηλώσεις Γάμου': 'πχ. "Ψάχνω βοήθεια για τη διοργάνωση του γάμου μου..."',
    'Εκδηλώσεις Βάφτισης': 'πχ. "Ψάχνω βοήθεια για τη διοργάνωση βάφτισης..."',
    'Δικηγόρος': 'πχ. "Χρειάζομαι νομική συμβουλή για ενοικιαστήριο συμβόλαιο..."',
    'Λογιστής': 'πχ. "Χρειάζομαι λογιστική υποστήριξη για ατομική επιχείρηση..."',
    'Αρχιτέκτονας': 'πχ. "Θέλω σχέδια για ανακαίνιση διαμερίσματος..."',
    'Διατροφολόγος': 'πχ. "Θέλω διατροφικό πλάνο για απώλεια βάρους..."',
    'Personal Trainer': 'πχ. "Θέλω προσωπικό πρόγραμμα γυμναστικής στο σπίτι..."',
    'Ψυχολόγος': 'πχ. "Θέλω συνεδρίες για διαχείριση άγχους..."',
    'Baby Sitter': 'πχ. "Χρειάζομαι babysitter για 2 παιδιά, 2 βράδια/εβδομάδα..."',
    'Νοσηλευτής κατ\' οίκον': 'πχ. "Χρειάζομαι νοσηλευτική φροντίδα κατ\' οίκον για ηλικιωμένο..."',
    'Οδοντίατρος': 'πχ. "Θέλω καθαρισμό δοντιών..."',
    'Εκπαιδευτής Σκύλων': 'πχ. "Θέλω βασική εκπαίδευση για κουτάβι..."',
    'Βιολογικός Καθαρισμός': 'πχ. "Θέλω οικολογικό καθάρισμα σπιτιού..."',
    'Τεχνίτρια Νυχιών': 'πχ. "Θέλω manicure-pedicure με ημιμόνιμο..."',
    'Makeup Artist': 'πχ. "Θέλω μακιγιάζ για γάμο..."',
    'Tattoo Artist': 'πχ. "Θέλω τατουάζ μικρού μεγέθους στο χέρι..."',
    'Φιλόλογος': 'πχ. "Θέλω ιδιαίτερα μαθήματα έκθεσης για Λύκειο..."',
    'Καθηγητής Αγγλικών': 'πχ. "Θέλω ιδιαίτερα Αγγλικά για Lower..."',
    'Καθηγητής Μαθηματικών': 'πχ. "Θέλω ιδιαίτερα Μαθηματικά για Γ Λυκείου..."',
    'Καθηγητής Γαλλικών': 'πχ. "Θέλω ιδιαίτερα Γαλλικά για αρχάριο επίπεδο..."',
    'Καθηγητής Γερμανικών': 'πχ. "Θέλω ιδιαίτερα Γερμανικά για Β2..."',
    'Καθηγητής Ιταλικών': 'πχ. "Θέλω ιδιαίτερα Ιταλικά για αρχάριους..."',
    'Καθηγητής Ισπανικών': 'πχ. "Θέλω ιδιαίτερα Ισπανικά για αρχάριους..."',
    'Καθηγητής Βιολογίας': 'πχ. "Θέλω ιδιαίτερα Βιολογία για Πανελλήνιες..."',
    'Καθηγητής Φυσικής': 'πχ. "Θέλω ιδιαίτερα Φυσική για Λύκειο..."',
    'Καθηγητής Χημείας': 'πχ. "Θέλω ιδιαίτερα Χημεία για Λύκειο..."',
    'Καθηγητής Πληροφορικής': 'πχ. "Θέλω μαθήματα προγραμματισμού για αρχάριους..."',
  };
                    ...
                    Expanded(child: GestureDetector(
                      onTap: () async {
                        final v = await showModalBottomSheet<String>(
                          ...
                          backgroundColor: Colors.transparent,
                          isScrollControlled: true,
                          builder: (_) => _CategorySpecialtyPicker(selected: _selectedProfession),
                        );
...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> _changeProfilePhoto() async {
    try {
      ...
      await ref.putData(bytes, SettableMetadata(contentType: 'image/jpeg'));
      final url = await ref.getDownloadURL();
      await FirebaseFirestore.instance.collection('users').doc(uid).set({'profilePhotoUrl': url}, SetOptions(merge: true));
      // Αν είναι επαγγελματίας, ενημέρωσε και το professionals doc
      if (_role == 'professional') {
              ...
              content: Column(mainAxisSize: MainAxisSize.min, children: [
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    border: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: BorderSide.none),
                    suffixIcon: IconButton(
                      icon: Icon(showOld ? Icons.visibility_off : Icons.visibility, color: Colors.white38, size: 20),
                      onPressed: () => setSt(() => showOld = !showOld),
                    ),
                  ),
                ),
                const SizedBox(height: 12),
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    border: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: BorderSide.none),
                    suffixIcon: IconButton(
                      icon: Icon(showNew ? Icons.visibility_off : Icons.visibility, color: Colors.white38, size: 20),
                ...
                TextButton(
                  onPressed: () async {
                    ...
                    if (_newPassCtrl.text.trim().length < 6) {
                      ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(content: Text('Ο νέος κωδικός πρέπει να έχει τουλάχιστον 6 χαρακτήρες')));
                      return;
                    }
                    try {
                      final cred = EmailAuthProvider.credential(
                          email: _email!, password: _oldPassCtrl.text.trim());
                      await user.reauthenticateWithCredential(cred);
                      await user.updatePassword(_newPassCtrl.text.trim());
                      if (ctx.mounted) {
                        Navigator.pop(ctx);
                        ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(content: Text('Ο κωδικός άλλαξε! ✅')));
                      }
                    } catch (e) {
                      String msg = 'Σφάλμα. Δοκίμασε ξανά.';
                      if (e.toString().contains('wrong-password') || e.toString().contains('invalid-credential')) {
                        msg = 'Λάθος τρέχων κωδικός';
                      }
                      if (ctx.mounted) ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(content: Text(msg), backgroundColor: Colors.red));
                    }
                  },
                  child: const Text('Αλλαγή', style: TextStyle(color: kGold)),
                ),
              ],
            ));
        });
                ...
                child: Column(children: [
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      margin: const EdgeInsets.only(bottom: 10),
                      padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 12),
                      decoration: BoxDecoration(borderRadius: BorderRadius.circular(16), color: _g(0.05)),
                      child: Row(children: [
                        Container(
                          width: 44, height: 44,
                          decoration: BoxDecoration(shape: BoxShape.circle,
                          ...
                          child: ClipOval(child: _uploadingPhoto
                            ...
                            : _photoUrl != null
                              ? Image.network(_photoUrl!, fit: BoxFit.cover,
                                  errorBuilder: (_, __, ___) => Container(color: kGold.withValues(alpha: 0.15),
                                      child: const Icon(Icons.camera_alt, color: kGold, size: 20)))
                              : Container(color: kGold.withValues(alpha: 0.15),
                                  child: const Icon(Icons.camera_alt, color: kGold, size: 20))),
                        ),
                        const SizedBox(width: 14),
                        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          const Text('Φωτογραφία προφίλ', style: TextStyle(fontSize: 14, color: Colors.white, fontWeight: FontWeight.w500)),
                          Text(_photoUrl != null ? 'Πάτα για αλλαγή' : 'Πάτα για προσθήκη',
                              style: TextStyle(fontSize: 11, color: _g(0.35))),
                        ])),
                        Icon(Icons.chevron_right, color: _g(0.3), size: 20),
                      ]),
                    ),
                  ),
                  _ProfileRow(
...
const List<Map<String, dynamic>> _specialtyCategories = [
  {
    'category': 'Τεχνικοί',
    'items': [
      'Αλουμινάς', 'Απολυμάνσεις - Απεντομώσεις - Μυοκτονίες', 'Αποφράξεις', 'Γκαραζόπορτες - Ρολά - Συρόμενα', 'Γυάλισμα Μαρμάρων', 'Γυψοσανίδες',
      ...
      'Συναρμολόγηση Επίπλων', 'Τέντες - Σκίαστρα', 'Τεχνικός Καυστήρων', 'Υαλουργός', 'Υδραυλικός', 'Υπηρεσία Αποξήλωσης',
  ...
  },
  {
    'category': 'Υγεία',
    'items': [
      'Διατροφολόγος', 'Νοσηλευτής κατ\' οίκον', 'Οδοντίατρος',
      'Φυσιοθεραπευτής', 'Ψυχολόγος'
    ]
  },
  {
    'category': 'Σπίτι',
    'items': ['Baby Sitter', 'Βιολογικός Καθαρισμός', 'Εκπαιδευτής Σκύλων', 'Καθαρίστρια', 'Κηπουρός', 'Μετακομίσεις']
  },
  {
    'category': 'Εκπαίδευση',
    'items': [
      'Καθηγητής Αγγλικών', 'Καθηγητής Βιολογίας', 'Καθηγητής Γαλλικών',
      'Καθηγητής Γερμανικών', 'Καθηγητής Ιταλικών', 'Καθηγητής Ισπανικών',
      'Καθηγητής Μαθηματικών', 'Καθηγητής Πληροφορικής', 'Καθηγητής Φυσικής',
      'Καθηγητής Χημείας', 'Personal Trainer', 'Φιλόλογος'
    ]
  },
  {
    'category': 'Ψηφιακές',
    'items': [
      'Γραφίστας', 'Τεχνικός Υπολογιστών', 'Φωτογράφος', 'Web Developer'
    ]
  },
  {
    'category': 'Εκδηλώσεις',
    'items': [
      'Catering', 'Διοργάνωση Πάρτυ', 'DJ / Μουσική Εκδηλώσεων',
      'Εκδηλώσεις Βάφτισης', 'Εκδηλώσεις Γάμου', 'Φωτογράφος Εκδηλώσεων'
    ]
  },
  {
  ...
  {
    'category': 'Άλλα',
    'items': ['Αρχιτέκτονας', 'Δικηγόρος', 'Διακοσμητής Εσωτερικών Χώρων', 'Λογιστής']
  },
  {
    'category': 'Συνεργεία',
    'items': [
...
const List<String> _greekAreas = [
  ...
  // Βόρειος Τομέας
  'Αγία Παρασκευή', 'Αμαρούσιο', 'Βριλήσσια', 'Ηράκλειο Αττικής',
  'Κηφισιά', 'Λυκόβρυση-Πεύκη', 'Μεταμόρφωση', 'Νέα Ιωνία',
  'Παπάγου-Χολαργός', 'Πεντέλη', 'Φιλοθέη-Ψυχικό', 'Χαλάνδρι',
  // Δυτικός Τομέας
  'Αγία Βαρβάρα', 'Αγίων Αναργύρων-Καματερό', 'Αιγάλεω', 'Ίλιον',
  'Κορυδαλλός', 'Περιστέρι', 'Πετρούπολη', 'Χαϊδάρι',
  // Πειραιάς
  'Πειραιάς', 'Κερατσίνι-Δραπετσώνα', 'Νίκαια-Αγ.Ιω.Ρέντης', 'Πέραμα', 'Σαλαμίνα',
  // Ανατολική Αττική
  'Ανθούσα', 'Αχαρνές', 'Γέρακας', 'Διόνυσος', 'Κρυονέρι',
  'Μαραθώνας', 'Μαρκόπουλο', 'Παιανία', 'Παλλήνη', 'Ραφήνα-Πικέρμι',
  'Σπάτα-Αρτέμιδα', 'Ωρωπός',
  // Δυτική Αττική
  ...
  // ── ΘΕΣΣΑΛΟΝΙΚΗ ──
  'Θεσσαλονίκη', 'Αμπελόκηποι-Μενεμένη', 'Βόλβη', 'Δέλτα',
  'Εχέδωρος', 'Θέρμη', 'Καλαμαριά', 'Κορδελιό-Ευόσμος',
  'Λαγκαδάς', 'Νεάπολη-Συκιές', 'Παύλος Μελάς', 'Πυλαία-Χορτιάτης',
  'Σταυρούπολη', 'Χαλκηδόνα', 'Ωραιόκαστρο', 'Νέα Μηχανιώνα',

  // ── ΚΕΝΤΡΙΚΗ ΜΑΚΕΔΟΝΙΑ (εκτός Θεσσαλονίκης) ──
  'Βέροια', 'Νάουσα', 'Αλεξάνδρεια',           // Ημαθία
  'Κατερίνη', 'Δίον-Ολύμπος', 'Πύδνα-Κολινδρός', // Πιερία
  'Κιλκίς', 'Παιονία',                           // Κιλκίς
  'Πολύγυρος', 'Κασσάνδρα', 'Σιθωνία', 'Αριστοτέλης', 'Νέα Προποντίδα', // Χαλκιδική
  'Σέρρες', 'Ηράκλεια', 'Νέα Ζίχνη', 'Εμμανουήλ Παππάς', 'Σιντική', // Σέρρες

  // ── ΔΥΤΙΚΗ ΜΑΚΕΔΟΝΙΑ ──
  'Κοζάνη', 'Βοΐου', 'Εορδαία', 'Σερβίων',      // Κοζάνη
  'Φλώρινα', 'Αμύνταιο', 'Πρέσπες',              // Φλώρινα
  'Γρεβενά',                                       // Γρεβενά
  'Καστοριά', 'Νεστόριο', 'Άργος Ορεστικό',      // Καστοριά

  // ── ΑΝΑΤΟΛΙΚΗ ΜΑΚΕΔΟΝΙΑ & ΘΡΑΚΗ ──
  'Καβάλα', 'Παγγαίο', 'Νέστος', 'Θάσος',        // Καβάλα
  'Δράμα', 'Δοξάτο', 'Προσοτσάνη',               // Δράμα
  'Ξάνθη', 'Αβδήρα', 'Μύκη',                     // Ξάνθη
  'Κομοτηνή', 'Αρριανά', 'Ιάσμος', 'Μαρώνεια-Σαπές', // Ροδόπη
  'Αλεξανδρούπολη', 'Ορεστιάδα', 'Σουφλί', 'Διδυμότειχο', // Έβρος

  // ── ΘΕΣΣΑΛΙΑ ──
  'Λάρισα', 'Ελασσόνα', 'Τύρναβος', 'Φαρσαλα', 'Αγιά', 'Κιλελέρ', 'Τέμπη', // Λάρισα
  'Βόλος', 'Αλμυρός', 'Ζαγορά-Μουρέσι', 'Νότιο Πήλιο', 'Ρήγας Φεραίος', 'Σκιάθος', 'Σκόπελος', 'Αλόννησος', // Μαγνησία
  'Τρίκαλα', 'Καλαμπάκα', 'Πύλη', 'Φαρκαδόνα',  // Τρίκαλα
  'Καρδίτσα', 'Μουζάκι', 'Παλαμάς', 'Σοφάδες',  // Καρδίτσα
  ...
  // ── ΠΕΛΟΠΟΝΝΗΣΟΣ ──
  'Κόρινθος', 'Βέλο-Βόχα', 'Λουτράκι-Περαχώρα', 'Σικυώνιος', 'Νεμέα', 'Ξυλόκαστρο-Ευρωστίνη', // Κορινθία
  'Άργος-Μυκήνες', 'Επίδαυρος', 'Ερμιονίδα', 'Ναύπλιο',       // Αργολίδα
  'Τρίπολη', 'Βόρεια Κυνουρία', 'Νότια Κυνουρία', 'Μεγαλόπολη', // Αρκαδία
  'Σπάρτη', 'Ανατολική Μάνη', 'Δυτική Μάνη', 'Ελαφόνησος', 'Ευρώτας', 'Μονεμβασία', // Λακωνία
  'Καλαμάτα', 'Δήμος Μεσσήνης', 'Κυπαρισσία', 'Οιχαλία', 'Πύλος-Νέστορας', 'Τριφυλία', // Μεσσηνία

  // ── ΔΥΤΙΚΗ ΕΛΛΑΔΑ ──
  'Πάτρα', 'Αγρίνιο', 'Αίγιο', 'Αιγιαλεία', 'Δυτική Αχαΐα', 'Ερυμάνθεια', 'Καλαβρύτων', // Αχαΐα
  'Αμφιλοχία', 'Ακτίου-Βόνιτσας', 'Ιεράς Πόλης Μεσολογγίου', 'Ναυπακτία', 'Θέρμου', // Αιτωλοακαρνανία
  'Πύργος', 'Ανδρίτσαινα-Κρεστένων', 'Αρχαία Ολυμπία', 'Ζαχάρω', 'Πηνειός', // Ηλεία

  // ── ΗΠΕΙΡΟΣ ──
  'Ιωάννινα', 'Βόρειοι Τζουμέρκοι', 'Δωδώνη', 'Ζίτσα', 'Κόνιτσα', 'Πωγώνι', 'Φιλιάτες', // Ιωάννινα
  'Άρτα', 'Γεωργίου Καραϊσκάκη', 'Κεντρικών Τζουμέρκων', 'Νικολάου Σκουφά', // Άρτα
  'Πρέβεζα', 'Ζηρού', 'Πάργα', 'Φιλιππιάδας',  // Πρέβεζα
  'Ηγουμενίτσα', 'Σούλι', 'Φιλιατών',            // Θεσπρωτία

  // ── ΙΟΝΙΑ ΝΗΣΙΑ ──
  'Κέρκυρα', 'Παξοί',                             // Κέρκυρα
  'Αργοστόλι', 'Ιθάκη', 'Ληξούρι', 'Σάμη',      // Κεφαλονιά & Ιθάκη
  'Λευκάδα', 'Μεγανήσι',                          // Λευκάδα
  'Ζάκυνθος',                                      // Ζάκυνθος

  // ── ΚΡΗΤΗ ──
  'Ηράκλειο', 'Αρχάνες-Αστερούσια', 'Βιάννος', 'Γόρτυνα', 'Μαλεβίζι', 'Μινώα Πεδιάδας', // Ηράκλειο
  'Άγιος Νικόλαος', 'Ιεράπετρα', 'Οροπεδίου Λασιθίου', 'Σητεία', 'Σητειακός', // Λασίθι
  'Ρέθυμνο', 'Αγίου Βασιλείου', 'Αμαρίου', 'Ανωγείων', 'Μυλοποτάμου',        // Ρέθυμνο
  'Χανιά', 'Αποκορώνου', 'Γαύδος', 'Κανδάνου-Σελίνου', 'Κισσάμου', 'Πλατανιά', 'Σφακίων', // Χανιά

  // ── ΒΟΡΕΙΟ ΑΙΓΑΙΟ ──
  'Μυτιλήνη', 'Αγιάσος', 'Δυτικής Λέσβου', 'Πλωμαρίου',  // Λέσβος
  'Χίος', 'Αμανής', 'Ομηρούπολη',                           // Χίος
...
class _PickerContainer extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
        ...
        decoration: BoxDecoration(
            ...
            border: Border.all(color: kGold.withValues(alpha: 0.15))),
        // SafeArea: το ύψος παραπάνω βασίζεται στο ΣΥΝΟΛΙΚΟ ύψος οθόνης,
        // χωρίς να αφαιρεί τον χώρο της on-screen navigation bar — χωρίς αυτό
        // εδώ, σε κινητά με πλήκτρα πλοήγησης (όχι gesture nav), το τελευταίο
        // στοιχείο της λίστας (και μερικές φορές το ίδιο το κουμπί OK) έμενε
        // μισοκρυμμένο πίσω από τη μπάρα πλοήγησης του συστήματος.
                  ...
                  child: Container(
                    ...
                    child: ClipRRect(
                      ...
                      child: Stack(fit: StackFit.expand, children: [
                        // Εικόνα από professionals doc (ίδιο field με παλιούς)
                        if (d['profilePhotoUrl'] != null && (d['profilePhotoUrl'] as String).isNotEmpty)
                          Image.network(d['profilePhotoUrl'] as String, fit: BoxFit.cover,
...
class _ProPublicProfileScreenState extends State<_ProPublicProfileScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final photoUrl = _data['profilePhotoUrl'] as String? ?? _data['photoUrl'] as String?;
    ...
    // Read instagram/tiktok — can be username OR full URL
    final instagramRaw = (_data['instagram'] as String? ?? '').trim();
    final tiktokRaw = (_data['tiktok'] as String? ?? '').trim();
    // Normalize to full URLs for launching
    String _fixUrl(String raw) {
      // Fix double-dots in domain (e.g. tiktok..com → tiktok.com)
      try {
        final uri = Uri.parse(raw);
        final fixedHost = uri.host.replaceAll(RegExp(r'\.{2,}'), '.');
        return uri.replace(host: fixedHost).toString();
      } catch (_) { return raw; }
    }
    final instagram = instagramRaw.isEmpty ? '' : (instagramRaw.startsWith('http') ? _fixUrl(instagramRaw) : 'https://www.instagram.com/${instagramRaw.replaceAll('@', '')}');
              ...
              Align(
                ...
                child: GestureDetector(
                  ...
                  child: Container(width: 40, height: 40,
                      decoration: BoxDecoration(shape: BoxShape.circle, color: _g(0.06), border: Border.all(color: _g(0.1))),
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      gradient: LinearGradient(
                        ...
                        colors: [kGold.withValues(alpha: 0.08), kBg],
                      ),
                    ),
                    ...
                    child: Column(children: [
                      ...
                      Stack(alignment: Alignment.bottomRight, children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            shape: BoxShape.circle,
                            gradient: LinearGradient(colors: [kGoldLight.withValues(alpha: 0.6), kGoldDark.withValues(alpha: 0.6)]),
                            boxShadow: [BoxShadow(color: kGold.withValues(alpha: 0.4), blurRadius: 24, spreadRadius: 2)],
                          ),
                        ...
                        if (yearsExperience > 0)
                          Container(
                            ...
                            child: Text('${yearsExperience}χρ', style: const TextStyle(color: Colors.black, fontSize: 9, fontWeight: FontWeight.w900)),
                          ),
                      ]),
                      const SizedBox(height: 14),
                      ...
                      // ── Social buttons (top, only if has social) ──
                      if (hasSocial) ...[
                        const SizedBox(height: 20),
                        Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                          if (instagram.isNotEmpty)
                            _socialButton('Instagram', 'Instagram', const Color(0xFFE1306C), Icons.camera_alt_outlined,
                          ...
                          if (tiktok.isNotEmpty)
                            _socialButton('TikTok', 'TikTok', const Color(0xFF69C9D0), Icons.music_note_outlined,
                                () => launchUrl(Uri.parse(tiktok), mode: LaunchMode.externalApplication)),
                        ]),
                      ],
                    ]),
                  ),
                  ...
                  Padding(
                    ...
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          if (bio.isNotEmpty)
                            Padding(
                              ...
                              child: Text(bio, style: TextStyle(color: _g(0.75), fontSize: 13.5, height: 1.65)),
                            ),
                          // Divider
                          if (bio.isNotEmpty && (specialties.isNotEmpty || subSpecialties.isNotEmpty))
                            Padding(
                              padding: const EdgeInsets.symmetric(horizontal: 18, vertical: 14),
                              child: Container(height: 1, color: _g(0.07)),
                            )
                          ...
                          if (subSpecialties.isNotEmpty) ...[
                            ...
                            Padding(
                              padding: const EdgeInsets.fromLTRB(18, 0, 18, 0),
                              child: _miniCvLabel('Ειδικότητες'),
                            ),
                            const SizedBox(height: 8),
                            Padding(
                              padding: const EdgeInsets.fromLTRB(18, 0, 18, 0),
                              child: Wrap(spacing: 7, runSpacing: 7,
                                  children: subSpecialties.map((s) => _dimChip(s)).toList()),
                            ),
                          ],
                          const SizedBox(height: 18),
                        ]),
                      ...
                      Container(
                        ...
                        child: _reviews.isEmpty
                            ? Padding(
                                ...
                                child: Column(children: [
                                  Icon(Icons.star_outline_rounded, color: kGold.withValues(alpha: 0.4), size: 38),
                                  const SizedBox(height: 10),
                                  Text('Δεν υπάρχουν αξιολογήσεις ακόμα', style: TextStyle(color: _g(0.35), fontSize: 13)),
                                ]),
                              )
                            : Column(children: [
                                // Summary bar
                                    ...
                                    Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                      ...
                                      Row(children: List.generate(5, (i) => Icon(
                                        i < gorealaiRating.floor() ? Icons.star_rounded
                                            : (i < gorealaiRating ? Icons.star_half_rounded : Icons.star_outline_rounded),
                                        color: kGold, size: 18,
                                      ))),
                                      const SizedBox(height: 4),
                                      Text('${_reviews.length} κριτικές', style: TextStyle(color: _g(0.4), fontSize: 11)),
                                    ]),
                                    const SizedBox(width: 20),
                                    Expanded(child: Column(children: List.generate(5, (idx) {
                                      final star = 5 - idx;
                                      final count = _reviews.where((r) => ((r['rating'] as num?)?.toDouble() ?? 0).round() == star).length;
                                      final frac = _reviews.isEmpty ? 0.0 : count / _reviews.length;
                                      return Padding(
                                        padding: const EdgeInsets.symmetric(vertical: 2),
                                        child: Row(children: [
                                          Text('$star', style: TextStyle(color: _g(0.5), fontSize: 10)),
                                          const SizedBox(width: 6),
                                          ...
                                          const SizedBox(width: 6),
                                          Text('$count', style: TextStyle(color: _g(0.4), fontSize: 10)),
                                        ]),
                                      );
                                    }))),
                                  ]),
                                ...
                                ..._reviews.take(5).map((r) {
                                  final rName = r['userName'] as String? ?? 'Χρήστης';
                                  final rRating = (r['rating'] as num?)?.toDouble() ?? 0;
                                  final rComment = r['comment'] as String? ?? '';
                                  ...
                                  return Container(
                                    ...
                                    decoration: BoxDecoration(border: Border(top: BorderSide(color: _g(0.07)))),
                                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                      Row(children: [
                                        Container(
                                          width: 34, height: 34,
                                          decoration: BoxDecoration(shape: BoxShape.circle, color: kGold.withValues(alpha: 0.12),
                                              border: Border.all(color: kGold.withValues(alpha: 0.25))),
                                          child: Center(child: Text(rName.isNotEmpty ? rName[0].toUpperCase() : 'X',
                                              style: const TextStyle(color: kGold, fontSize: 14, fontWeight: FontWeight.w700))),
                                        ),
                                        const SizedBox(width: 10),
                                        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                          Text(rName, style: const TextStyle(color: Colors.white, fontSize: 13, fontWeight: FontWeight.w700)),
                                          if (dateStr.isNotEmpty)
                                            Text(dateStr, style: TextStyle(color: _g(0.35), fontSize: 10)),
                                        ])),
                                        Row(children: List.generate(5, (i) => Icon(
                                          i < rRating.floor() ? Icons.star_rounded : (i < rRating ? Icons.star_half_rounded : Icons.star_outline_rounded),
                                          color: kGold, size: 13,
                                        ))),
                                      ]),
                                      if (rComment.isNotEmpty) ...[
                                        const SizedBox(height: 8),
                                        Text(rComment, style: TextStyle(color: _g(0.65), fontSize: 13, height: 1.5)),
                                      ],
                                    ]),
                                  );
                                }),
                      ...
                      // GOOGLE REVIEWS
                      // ══════════════════════════════════════
                      _sectionHeader('ΑΞΙΟΛΟΓΗΣΕΙΣ GOOGLE'),
                      Container(
                        width: double.infinity,
                        decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(20),
                        ...
                        child: (companyName.isEmpty && (googleRating == null || googleRating == 0))
                            ? Padding(
                                padding: const EdgeInsets.symmetric(vertical: 30),
                                child: Column(children: [
                                ...
                                child: Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
                                  ...
                                  Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                    if (companyName.isNotEmpty)
                                      Text(companyName, style: const TextStyle(color: Colors.white, fontSize: 15, fontWeight: FontWeight.w800)),
                                    const SizedBox(height: 6),
                                    if (googleRating != null && googleRating > 0) ...[
                                      Row(children: [
                                        ...
                                        Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                          Row(children: List.generate(5, (i) => Icon(
                                            i < googleRating.floor() ? Icons.star_rounded : (i < googleRating ? Icons.star_half_rounded : Icons.star_outline_rounded),
                                            color: const Color(0xFFFBBC05), size: 16,
                                          ))),
                                          if (googleRatingCount > 0) ...[
                                            const SizedBox(height: 3),
                                            Text('$googleRatingCount κριτικές', style: TextStyle(color: _g(0.4), fontSize: 11)),
                                          ],
                                        ]),
                                      ]),
                                    ] else
                                      Text('Δεν υπάρχουν αξιολογήσεις', style: TextStyle(color: _g(0.35), fontSize: 12)),
                                  ])),
                                ]),
                              )),
                      ),
                      ...
                      if (_projects.isNotEmpty) ...[
                              ...
                              itemBuilder: (_, i) {
                                ...
                                return GestureDetector(
                                  ...
                                  child: AnimatedContainer(
                                    ...
                                    decoration: BoxDecoration(
                                      borderRadius: BorderRadius.circular(22),
                                      color: sel ? kGold.withValues(alpha: 0.15) : _g(0.04),
                                      border: Border.all(color: sel ? kGold : _g(0.09), width: sel ? 1.5 : 1),
                                    ),
                                    child: Text(_projects[i]['title'] as String? ?? '',
                                        style: TextStyle(color: sel ? kGold : _g(0.5), fontSize: 12, fontWeight: sel ? FontWeight.w700 : FontWeight.w500)),
                                  ),
                                );
                              },
                            ),
                        ...
                        _buildPublicAlbum(_projects[_portfolioIndex.clamp(0, _projects.length - 1)]),
                        const SizedBox(height: 24),
                      ],
                      ...
                      GestureDetector(
                        onTap: () async {
                          ...
                          // Use Auth UID (userId field) so badge query matches
                          final proUid = (_data['userId'] ?? widget.proId) as String;
                          final chatId = '${user.uid}_$proUid';
                          if (!mounted) return;
                          Navigator.push(context, PageRouteBuilder(
                            pageBuilder: (_, __, ___) => ChatScreen(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(18),
                            gradient: const LinearGradient(colors: [kGoldLight, kGold, kGoldDark]),
                            boxShadow: [BoxShadow(color: kGold.withValues(alpha: 0.4), blurRadius: 20, offset: const Offset(0, 8))],
                          ),
                          child: const Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                            Icon(Icons.chat_bubble_outline_rounded, color: Colors.black, size: 18),
                            SizedBox(width: 8),
                            Text('Επικοινώνησε με τον Επαγγελματία',
                                style: TextStyle(color: Colors.black, fontSize: 14, fontWeight: FontWeight.w900, letterSpacing: 0.3)),
                          ]),
                        ),
                      ),
                    ]),
  ...
  Widget _buildPublicAlbum(Map<String, dynamic> project) {
    final photos = project['photos'] as List<String>? ?? [];
    if (photos.isEmpty) {
      return Container(
        height: 120,
        decoration: BoxDecoration(borderRadius: BorderRadius.circular(18), color: _g(0.03), border: Border.all(color: _g(0.07))),
    ...
    return SizedBox(
      ...
      child: ListView.separated(
        ...
        itemBuilder: (_, i) => GestureDetector(
          onTap: () => _showViewer(photos, i),
          child: ClipRRect(
            borderRadius: BorderRadius.circular(14),
            child: Image.network(photos[i], width: 180, height: 220, fit: BoxFit.cover,
                errorBuilder: (_, __, ___) => Container(width: 180, color: _g(0.06), child: Icon(Icons.broken_image, color: _g(0.2)))),
          ),
        ),
      ),
    );
  ...
  void _showViewer(List<String> photos, int i) => showDialog(
    context: context, barrierColor: Colors.black87,
    builder: (_) => _PhotoViewerDialog(photos: photos, initialIndex: i),
  );

  Widget _initialsBox(String i) => Container(
    color: kGold.withValues(alpha: 0.1),
    child: Center(child: Text(i, style: const TextStyle(color: kGold, fontSize: 38, fontWeight: FontWeight.bold))),
  );
  ...
  Widget _statDivider() => Container(
    height: 28, width: 1, margin: const EdgeInsets.symmetric(horizontal: 18),
    color: _g(0.1),
  );
  ...
  Widget _sectionHeader(String text) => Padding(
    ...
    child: Row(children: [
      ShaderMask(
        shaderCallback: (b) => const LinearGradient(colors: [kGoldLight, kGold]).createShader(b),
        child: Container(width: 3, height: 14, decoration: BoxDecoration(borderRadius: BorderRadius.circular(2), color: Colors.white)),
      ),
      const SizedBox(width: 10),
      Text(text, style: const TextStyle(color: Colors.white, fontSize: 11, fontWeight: FontWeight.w800, letterSpacing: 1.8)),
    ]),
  );
  ...
  Widget _goldChip(String label) => Container(
    padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 6),
    decoration: BoxDecoration(borderRadius: BorderRadius.circular(20), color: kGold.withValues(alpha: 0.12), border: Border.all(color: kGold.withValues(alpha: 0.35))),
  ...
  Widget _dimChip(String label) => Container(
    ...
    decoration: BoxDecoration(borderRadius: BorderRadius.circular(20), color: _g(0.05), border: Border.all(color: _g(0.09))),
    child: Text(label, style: TextStyle(color: _g(0.65), fontSize: 11)),
  );

  Widget _socialButton(String platform, String handle, Color color, IconData icon, VoidCallback onTap) =>
      GestureDetector(
        onTap: onTap,
        child: Container(
          ...
          child: Row(mainAxisSize: MainAxisSize.min, children: [
            ...
            const SizedBox(width: 7),
            Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Text(platform, style: TextStyle(color: color, fontSize: 9, fontWeight: FontWeight.w800, letterSpacing: 0.5)),
              Text(handle, style: TextStyle(color: color.withValues(alpha: 0.9), fontSize: 12, fontWeight: FontWeight.w600)),
            ]),
          ]),
        ),
      );
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        const SizedBox(height: 24),
        ...[
          {'emoji': '💍', 'title': 'Γάμος', 'subs': 'Φωτογράφος · DJ · Catering'},
          ...
          child: SingleChildScrollView(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              if (_googleRating != null && _googleRating! > 0) ...[
                ...
                const SizedBox(height: 10),
                GestureDetector(
                  onTap: _googleMapsUrl.isEmpty ? null : () =>
                      launchUrl(Uri.parse(_googleMapsUrl), mode: LaunchMode.externalApplication),
                  child: Container(
                  width: double.infinity,
                  padding: const EdgeInsets.all(16),
                  decoration: BoxDecoration(
                  ...
                  child: Row(children: [
                    ...
                    if (_googleMapsUrl.isNotEmpty)
                      Icon(Icons.open_in_new_rounded, color: const Color(0xFF4285F4).withValues(alpha: 0.5), size: 18),
                  ]),
                  ),
                ),
              ],
...
class _DirectRequestScreenState extends State<DirectRequestScreen> {
  ...
  Future<void> _send() async {
    ...
    try {
      ...
      final userName = userDoc.data()?['name'] ?? 'Χρήστης';
      final pro = widget.pro;
      // Prefer userId (Auth UID) so badge query matches; fall back to doc id
      final proId = (pro['userId'] ?? pro['id'] ?? pro['uid'] ?? '') as String;
...
class MessagesScreen extends StatefulWidget {
  final String userId;
  final bool isPro;
  const MessagesScreen({super.key, required this.userId, this.isPro = false});
  @override
    ...
    return Scaffold(
      ...
      body: SafeArea(child: Column(children: [
        ...
        Expanded(child: StreamBuilder<QuerySnapshot>(
          stream: FirebaseFirestore.instance
              .collection('chats')
              .where(widget.isPro ? 'proId' : 'userId', isEqualTo: widget.userId)
              .snapshots(),
          builder: (context, snap) {
            if (!snap.hasData) return const Center(child: CircularProgressIndicator(color: kGold));
            ...
            return ListView.builder(
              ...
              itemBuilder: (_, i) {
                ...
                final userName2 = d['userName'] as String? ?? 'Χρήστης';
                final displayName = widget.isPro ? userName2 : proName;
                      ...
                      child: Row(children: [
                        ...
                        Container(
                          ...
                          child: ClipOval(child: () {
                              final uid = widget.isPro
                                  ? (d['userId'] as String? ?? '')
                                  : proId2;
                              if (uid.isEmpty) {
                                return Center(child: Text(displayName.isNotEmpty ? displayName[0].toUpperCase() : '?',
                                    style: const TextStyle(color: kGold, fontSize: 21, fontWeight: FontWeight.w900)));
                              }
                              // Φόρτωσε από professionals (για pro avatar) ή users (για user avatar)
                              // και κάνε fallback στο άλλο collection αν δεν υπάρχει φωτό
                              final primaryCol = widget.isPro ? 'users' : 'professionals';
                              final fallbackCol = widget.isPro ? 'professionals' : 'users';
                              return FutureBuilder<String?>(
                                future: FirebaseFirestore.instance.collection(primaryCol).doc(uid).get().then((s) {
                                  final url = (s.data()?['profilePhotoUrl'] as String?);
                                  if (url != null && url.isNotEmpty) return url;
                                  // Fallback στο άλλο collection
                                  return FirebaseFirestore.instance.collection(fallbackCol).doc(uid).get().then((s2) =>
                                      s2.data()?['profilePhotoUrl'] as String?);
                                }),
                                builder: (_, snap) {
...
class _ChatScreenState extends State<ChatScreen> {
  ...
  void initState() {
    ...
    _chatDocSub = FirebaseFirestore.instance
      ...
      // If I'm pro, I want to know when the user last read; if I'm user, when the pro last read
  ...
  Future<void> _markAsRead() async {
    try {
      final unreadField = widget.isPro ? 'unreadPro' : 'unreadUser';
      final lastReadField = widget.isPro ? 'proLastReadAt' : 'userLastReadAt';
      await FirebaseFirestore.instance
          .collection('chats').doc(widget.chatId)
          .set({
            unreadField: 0,
            lastReadField: FieldValue.serverTimestamp(),
          }, SetOptions(merge: true));
    } catch (_) {}
  }
  ...
  Future<void> _sendMessage() async {
    ...
    try {
      ...
      await chatRef.set({
        ...
        if (chatParts.isNotEmpty) 'userId': chatParts[0],
        if (chatParts.length > 1) 'proId': chatParts[1],
        // Always persist names so both sides see the correct name
        'userName': widget.isPro ? widget.otherName : widget.currentUserName,
        'proName': widget.isPro ? widget.currentUserName : widget.otherName,
      }, SetOptions(merge: true));
...
class _EventOrganizerScreenState extends State<EventOrganizerScreen> {
  ...
  static const _categories = [
    {'id': 'wedding', 'emoji': '💍', 'title': 'Γάμος',
     'subtitle': 'Φωτογράφος · DJ · Catering',
     'pros': ['Εκδηλώσεις Γάμου','Φωτογράφος Εκδηλώσεων','DJ / Μουσική Εκδηλώσεων','Catering']},
    {'id': 'baptism', 'emoji': '👶', 'title': 'Βάφτιση',
     'subtitle': 'Φωτογράφος · Catering · Στολισμός',
     'pros': ['Εκδηλώσεις Βάφτισης','Φωτογράφος Εκδηλώσεων','Catering']},
    {'id': 'party', 'emoji': '🎉', 'title': 'Πάρτυ',
     'subtitle': 'DJ · Catering · Φωτογράφος',
     'pros': ['Διοργάνωση Πάρτυ','DJ / Μουσική Εκδηλώσεων','Catering','Φωτογράφος Εκδηλώσεων']},
  ];
