...
const THESSALONIKI_SECTORS = {
  'θεσσαλονίκη': ['θεσσαλονίκη', 'αμπελόκηποι-μενεμένη', 'βόλβη', 'δέλτα', 'εχέδωρος', 'θέρμη', 'καλαμαριά', 'κορδελιό-ευόσμος', 'λαγκαδάς', 'νεάπολη-συκιές', 'παύλος μελάς', 'πυλαία-χορτιάτης', 'σταυρούπολη', 'ωραιόκαστρο', 'νέα μηχανιώνα'],
};
